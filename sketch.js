...
fill("black")
textSize(20)
text("PRESS W , A , S , D TO SHOOT BULLETS.",410,200)

fill("black")
textSize(15)
text("CLICK CTRL R TO REPLAY GAME IF YOU LOST.",410,220)
...
if(player.isTouching(virus1)){
  background("white")
  fill("black")
  textSize(30)
  text("YOU LOST THE GAME",0,200);
  player.destroy()
}

if(player.isTouching(virus2)){
  background("white")
  fill("black")
  textSize(30)
  text("YOU LOST THE GAME",0,200);
